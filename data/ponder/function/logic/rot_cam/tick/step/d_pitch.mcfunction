scoreboard players operation #remaining_dom ponder.scene.cam_rot = #total_pitch ponder.scene.cam_rot
scoreboard players operation #total_dom ponder.scene.cam_rot = #init_pitch ponder.scene.cam_rot
