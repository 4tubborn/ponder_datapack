data modify storage ponder:index scene."command_block" set value [\
    [\
        ...
        {type:"set_block",block:{block_state:{Name:"acacia_stairs",Properties:{facing:"east"}},state:"[facing=east]",pos:[2,1,1]}},\
        {type:"show_section",direction:"down"},\
        {type:"idle",duration:3},\
        {type:"set_block",block:{block_state:{Name:"diamond_block"},pos:[2,2,1]}},\
        {type:"show_section",direction:"east"},\
        {type:"idle",duration:3},\
        {type:"set_block",block:{block_state:{Name:"diamond_block"},pos:[2,3,1]}},\
        {type:"show_section"},\
        ...
        {type:"play_sound",sound:"entity.player.levelup",category:"player"},\
    ]\
]
