...
execute unless dimension ponder:ponder run return run schedule function ponder:util/ponder/init/ 1t
say init
...
function ponder:util/ponder/init/restore_gamerule with storage ponder:tmp
