...
execute if score x u.variable matches -21474836..21474836 run return run function u.math:x/mult_100_div_y/case_0
execute if score y u.variable matches -101..100 run return run function u.math:x/mult_100_div_y_checked/case_check
execute if score y u.variable matches -21474836..21474836 run return run function u.math:x/mult_100_div_y/case_1
execute if score x u.variable matches 0.. run return run function u.math:x/mult_100_div_y/case_2
scoreboard players operation #t2 u.variable = x u.variable
scoreboard players operation #t2 u.variable *= #100 u.constant
scoreboard players operation #t3 u.variable = y u.variable
scoreboard players operation #t1 u.variable = y u.variable
scoreboard players operation #t1 u.variable /= #100 u.constant
